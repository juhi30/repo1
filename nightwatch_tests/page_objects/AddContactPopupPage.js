const addContactsCommands = {
  renderAddContactsPage: function() {
    return this.waitForElementVisible(
      "@addContactButton",
      5000,
      "Add Contacts popup is visible"
    );
  },

  renderPageElements: function() {
    return this.verify
      .visible("@avatarPicture", "Avatar picture is visible")
      ...
      .verify.visible(
        ...
        "Connect party button is visible"
      ) //throwing error but working fine in click clickConnectParties()
  ...
  validateErrorPrompt: function() {
    return this.waitForElementVisible(
      "@requiredInputAlert",
      2000,
      "Required input alert is visible"
    ).verify.containsText(
      "@requiredInputAlert",
      "First name is required, Last name is required, Birthday is required for all patients",
      "Alert message is right"
    );
  },

  validateInputValidators: function() {
    return this.verify
      .visible("@nullFirstName", "First name validator is visible")
  ...
  clickClosePhotoPopup: function() {
    return this.click("@addPhotoCloseButton").waitForElementNotPresent(
      "@addPhotoCloseButton",
      5000,
      "Add photo popup is no longer visible"
    );
  },

  clickConnectParties: function() {
    return this.verify
      .visible("@connectedPartyButton", "Connect party button is visible")
      .click("@connectedPartyButton")
      .waitForElementVisible(
        "@connectedPartyDropdown",
        5000,
        "Connect parties dropdown is visible"
      );
  },

  fillInFormPartOne: function(
    firstName,
    lastName,
    preferredName,
    month,
