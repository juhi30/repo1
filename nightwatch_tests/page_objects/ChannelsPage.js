const channelsCommands = {
  ...
  validateEditForm: function() {
    return this.click("@editChannel")
      .waitForElementVisible(
        ...
        5000,
        "Edit channel form is visible"
      )
      .click("@editLocationDropdown")
      .waitForElementVisible(
        "@editLocationFirstResult",
        5000,
        "First location is visible"
      )
    ...
    return (
      this.click("@editChannel")
        ...
        .verify.valueContains(
          "@editChannelName",
          channelName + randoNum,
          "The title is " +
            channelName +
            " and random number which is " +
            randoNum
        )
  ...
  clickCreateNewFBChannel: function() {
    return this.waitForElementVisible(
      "@addChannelButton",
      5000,
      "Add channel button is visible"
    )
      .click("@addChannelButton")
      .waitForElementVisible(
        "@addChannelDropdown",
        5000,
        "Add facebook dropdown is visible"
      )
  ...
  validateConnectFBPopup: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "Connect to facebook popup is visible"
    );
  },
  ...
  validateFacebookPagePopup: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "Facebook page selection popup is visible"
    );
  ...
  loginFacebook: function(email, password) {
    return this.waitForElementVisible(
      "@facebookLoginPage",
      5000,
      "Facebook login page is visible"
    )
  ...
  clickFacebookPage: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "First facebook page choice is visible"
    )
  ...
  validateConnectFBAcctPopup: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "Connect facebook account popup is visible"
    )
      .click("@facebookLocationDropdown")
      .waitForElementVisible(
        "@facebookFirstLocation",
        5000,
        "First location choice is visible"
      );
  },

  finalizeCreateNewFBChannel: function(channelName) {
    return this.verify
      .valueContains("@connectFacebookAcctChannelName", channelName)
      .click("@facebookLocationDropdown")
      .waitForElementVisible(
        "@facebookFirstLocation",
        5000,
    ...
    return (
      this.waitForElementVisible(
        ...
        .waitForElementVisible(
          "@deleteChannelFinal",
          5000,
          "Delete channel popup is visible"
        )
        ...
        .waitForElementNotPresent(
          "@deleteChannelPopup",
          5000,
          "Delete channel popup is not visible"
        )
        .waitForElementNotPresent(
          "@facebookChannelContainer",
          5000,
          "Facebook channel is deleted"
        )
    );
  }
};
