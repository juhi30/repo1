...
module.exports = {
  ...
  'Change to Contacts url, render and verify Page elements': function (client) {
    ...
    contacts.navigate().validateContactsElements().clickAddContact();
  ...
  'Click and validate filters are working': function (client) {
    ...
    contacts.clickPatientOption().pause(500).clickMemberOption().pause(500).clickConnectedPartyOption().pause(500).clickUnknownOption().pause(500).clickOtherOption().pause(500).clickAllContactsOption();
