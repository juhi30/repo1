const billingCommands = {
  ...
  validatePaymentEls: function() {
    return this.waitForElementPresent(
      "@paymentTab",
      5000,
      "Payment tab is visible"
    )
      .click("@paymentTab")
      .waitForElementVisible(
        "@changePaymentButton",
        5000,
        "Payment tab elements are visible"
      )
      ...
      .verify.visible(
        ...
        "Billing address input is visible"
      )
  ...
  fillInCreditCardForm: function() {
    return this.waitForElementVisible(
      "@creditCardRadio",
      5000,
      "Payment radios are visible"
    )
      .click("@creditCardRadio")
      .waitForElementVisible(
        "@creditCardNumInput",
        5000,
        "credit card inputs visible"
      )
  ...
  savePaymentMethod: function() {
    return this.waitForElementVisible(
      "@savePaymentButton",
      5000,
      "Save payment button is visible"
  ...
  changePaymentMethod: function() {
    return this.waitForElementVisible(
      "@changePaymentButton",
      5000,
      "change payment button is visible"
    ).click("@changePaymentButton");
  },
