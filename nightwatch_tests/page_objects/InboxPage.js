const inboxCommands = {
  ...
  searchResultNotVisible: function() {
    return this.waitForElementVisible("body", 5000).verify.elementNotPresent(
      "@firstResultNewMessageSearch",
      "First input result is not visible"
    );
  },
  ...
  searchResultVisible: function() {
    return this.waitForElementVisible(
      "@firstResultNewMessageSearch",
      5000,
      "First result of the search is visible"
    ).verify.visible(
      "@firstResultNewMessageSearch",
      "First input result is visible"
    );
  },
  ...
  clickFirstResult: function() {
    return this.waitForElementVisible(
      ...
      .verify.urlContains(
        "profileOpen=1",
        "The page address goes to conversation thread and profile view"
      );
  },
