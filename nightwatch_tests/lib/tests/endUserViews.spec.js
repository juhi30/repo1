...
module.exports = {
  ...
  'Login Page with Correct Credentials': function (client) {
    ...
    login.navigate().enterPatientCreds().submit();
  },
  ...
  'Changing the password': function (client) {
    ...
    EUProfile.navigate().clickChangePassword().fillInCurrentPasswordInput('chacoz').fillInNewPasswordInput('chacoz').fillInRetypeNewPasswordInput('chacoz').clickSavePassword().verifyPasswordUpdatedToast();
  },
