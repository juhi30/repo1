...
const auditLogsCommands = {
  ...
  validateTagEntry(action, tagName) {
  ...
  validateEventEntry(action, entryTitle, memberName, category) {
  ...
  validateEventEntryWithNoDataFound(action, entryTitle, memberName, category) {
    return this.waitForElementVisible('@auditEntry', 'Event entry is visible')
      .waitForElementVisible('@linkText', 'Details Link text is visible')
      .click('@linkText')
      .verify.visible('@dateAndTime', 'Date and Time is visible')
  ...
  validateTemplateEntry(templateTitle, member, action, category) {
  ...
  validateSystemTemplateEntry(templateTitle, member, action, category) {
  ...
  checkAuditOrgEntry(category, action, orgName, member) {
  ...
  checkAuditChannelEntry(category, action, channelName, member) {
...
module.exports = {
  ...
  elements: {
    ...
    staticFieldWithNoDataFound: {
      selector: '//SPAN[text()=\'No Data Found\']',
      locateStrategy: 'xpath',
    },
