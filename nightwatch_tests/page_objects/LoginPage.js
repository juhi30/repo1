...
const loginCommands = {
  ...
  submitForFirstTime: function() {
    return this.waitForElementVisible(
      ...
      .waitForElementNotPresent(
        "@usernameInput",
        5000,
        "Username input no longer present"
      );
  },
  ...
  validateError: function() {
    return this.waitForElementVisible(
      "@errorPrompt",
      5000,
      "Error logging in prompt is visible"
    )
  ...
  validateUrlChange: function() {
    return this.waitForElementNotPresent(
      ...
      false,
      null,
      "Login button is no longer visible, page changes to inbox"
  ...
  clickSaveAndContinueButton: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "Save and Continue button is visible"
