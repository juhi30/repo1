...
module.exports = {
  ...
  'Render and validate edit channel form': function (client) {
    ...
    channelsPage.navigate().validateChannelsElements().validateEditForm();
  ...
  'Render and create channel elements and popups': function (client) {
    ...
    channelsPage.navigate().validateChannelsElements().clickCreateNewFBChannel().validateConnectFBPopup().clickConnectFacebook();
    ...
    channelsPage.validateFacebookPagePopup().clickFacebookPage().validateConnectFBAcctPopup().finalizeCreateNewFBChannel('Rhino\'s Night Moves');
  ...
  'Validate and remove added channel and elements': function (client) {
    ...
    channelsPage.navigate().validateChannelAdded().removeChannelAdded();
