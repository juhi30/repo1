const preferencesCommands = {
  ...
  renderPageElements: function() {
    return (
      this.waitForElementVisible(
        "@desktopInboxToggle",
        5000,
        "Desktop inbox toggle is visible"
      )
        ...
        .verify.visible(
          ...
          "Save preferences button is visible"
        )
  ...
  validateToggleChange: function() {
    return this.verify
      .cssProperty(
        ...
        "background-color",
        "rgba(131, 196, 0, 1)",
        "Desktop inbox toggle color is green and on"
      )
      .verify.cssProperty(
        "@desktopChatToggle",
        "background-color",
        "rgba(131, 196, 0, 1)",
        "Desktop chat toggle is green and on"
      );
  ...
  clickSavePreferences: function() {
    return this.click("@savePreferencesButton").waitForElementVisible(
      "@saveToast",
      5000,
      "Save preferences toast is visible"
    );
  }
};
