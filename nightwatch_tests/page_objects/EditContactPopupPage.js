const editContactCommands = {
  connectExistingContact: function(existingContact) {
    return this.waitForElementVisible('@addAConnectedPartyLink', 5000, 'Add a connected party link is visible')
      .click('@addAConnectedPartyLink')
      .waitForElementVisible('@connectedPartySearchInput', 5000, 'CP search input is visible')
      .setValue('@connectedPartySearchInput', existingContact)
      .waitForElementVisible('@firstCPSearchResult', 5000, 'First result is visible')
      .click('@firstCPSearchResult')
  },

  clickSaveContact: function() {
    return this.waitForElementVisible('@saveContactButton', 5000, 'Save contact button is visible')
      .click('@saveContactButton');
  },

  createNewContactAndCP: function(firstName, lastName) {
    return this.waitForElementVisible('@addAConnectedPartyLink', 5000, 'Add Conn Party link is visible')
      .click('@addAConnectedPartyLink')
      .waitForElementVisible('@addNewContactLinkInDropdown', 5000, 'Add new contact link is visible')
      .click('@addNewContactLinkInDropdown')
      .waitForElementVisible('@connectedPartyFirstNameInput', 5000, 'Name inputs are visible')
      .setValue('@connectedPartyFirstNameInput', firstName)
      .setValue('@connectedPartyLastNameInput', lastName)
      .click('@createNewButton')
      .waitForElementNotPresent('@connectedPartyFirstNameInput', 5000, 'Inputs are hidden')
  },
}
