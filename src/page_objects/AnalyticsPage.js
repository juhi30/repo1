...
const { dateRangePickerOptions, analyticsChartsNames, analyticsOpenConversationUI, analyticsClosedConversationUI } = helpers;
...
const analyticsCommands = {
    ...
    validateOpenConversations: function() {
    ...
    validateFiltersOnConversations: function() {
        const self = this;
        return this.waitForElementVisible('@defaultTabOpen', 'Open Conversations Tab is visible')
          .click('@filterByContactButton')
          .waitForElementVisible('@firstRowConversation', 'First Row of Conversations is visible after clicking Contact filter', function(result) {
            if(result.value){
    ...
    validateClosedConvoDatePickerAndOptions: function() {
    ...
    validateOpenConvoContactNavigation: function() {
        const self = this;
        return this.click('@openTab')
            .waitForElementVisible('@firstRowConversation', 'First Row of Conversations is visible', function(result) {
                    logger.info(result.value, 'open');
                    if(result.value){
    ...
    validateClosedConvoContactNavigation: function() {
        const self = this;
    ...
    validateDefaultDateRangeInConvoGrid: function() {
