...
const groupsPageCommands = {
  ...
  verifyGroupEls: function () {
    return this.waitForElementVisible('@createButton', 'Create Button is visible')
      .click('@createButton')
      .waitForElementVisible('@groupPageTitle', 'Group Page Title is visible')
      .verify.visible('@teamOption', 'Team option is visible')
...
module.exports = {
  ...
  elements: {
    ...
    createGroupButton: {
      selector: `//SPAN[@class='button__text-wrapper'][contains(text(),'Create Group')]`,
      locateStrategy: 'xpath',
    },
