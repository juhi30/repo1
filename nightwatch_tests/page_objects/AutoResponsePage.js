const autoResponseCommands = {
  ...
  validateAutoResponseElements: function() {
    return (
      this.waitForElementVisible(
        "@autoResponseInput",
        5000,
        "Auto-Response input is visible ready for test"
      )
        .verify.visible(
          "@autoResponseInput",
          "Auto-Response text area is visible"
        )
        .verify.visible(
          "@saveAutoResponseButton",
          "Save Auto-Response button is visible"
        )
        ...
        .verify.visible(
          "@scheduleEventButton",
          "Schedule event button is visible"
        )
  ...
  validateAutoResponsePopupElements: function() {
    return this.waitForElementVisible(
      ...
      .waitForElementVisible(
        "@submitEventButton",
        4000,
        "Submit event button on popup is visible"
      )
      ...
      .verify.visible(
        ...
        "Auto-Response input in popup is visible"
      )
      .verify.visible(
        "@channelsDropdown",
        "Channels dropdown tab in popup is visible"
      )
      ...
      .verify.visible(
        "@firstChannelInDropdown",
        "First channel in popup is visible"
      )
      .click("@firstChannelInDropdown")
      .verify.visible(
        "@submitEventButton",
        "Submit event button in popup is visible"
      )
      .waitForElementVisible(
        "@cancelButtonInNewOOOForm",
        5000,
        "Cancel button in popup is visible"
      )
  ...
  validateDeletePopup: function() {
    return this.waitForElementVisible(
      ...
      .waitForElementVisible(
        ...
        5000,
        "Delete event popup is visible"
      )
      .verify.visible("@deleteButtonFinal", "Delete button final is visible")
      .verify.visible(
        "@cancelDeletePopupButton",
        "Cancel delete popup button is visible"
      )
      .verify.visible(
        "@closeDeletePopupButton",
        "Close delete popup (X) button is visible"
      )
  ...
  fillInOOOEvent: function() {
    return this.waitForElementVisible(
      ...
      .waitForElementNotPresent(
        "@fromTimeInput",
        5000,
        "From time input is not visible"
      )
      .waitForElementNotPresent(
        "@toTimeInput",
        5000,
        "To time input is not visible"
      )
      .clearValue("@autoResponseInputInPopup")
      .setValue(
        "@autoResponseInputInPopup",
        "Hi Im a sentient computer program... ergo... vis a vie..."
      )
  ...
  deleteLastOOOEvent: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "2nd Delete event button is visible"
    )
