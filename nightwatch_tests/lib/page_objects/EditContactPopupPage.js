...
const editContactCommands = {
  ...
  clickSaveContact: function () {
    return this.waitForElementVisible('@saveContactButton', 5000, 'Save contact button is visible').click('@saveContactButton');
  },

  createNewContactAndCP: function (firstName, lastName) {
    return this.waitForElementVisible('@addAConnectedPartyLink', 5000, 'Add Conn Party link is visible').click('@addAConnectedPartyLink').waitForElementVisible('@addNewContactLinkInDropdown', 5000, 'Add new contact link is visible').click('@addNewContactLinkInDropdown').waitForElementVisible('@connectedPartyFirstNameInput', 5000, 'Name inputs are visible').setValue('@connectedPartyFirstNameInput', firstName).setValue('@connectedPartyLastNameInput', lastName).click('@createNewButton').waitForElementNotPresent('@connectedPartyFirstNameInput', 5000, 'Inputs are hidden');
  }
};
