...
module.exports = {
  ...
  'Render and validate Channels page': function (client) {
    ...
    channelsPage.navigate().validateChannelsEls();
  ...
  'Render and validate Edit Channels page': function (client) {
    ...
    channelsPage.navigate().navigateToEditChannels();

    createEditChannelsPage.validateEditEls().validateEditAndCreateEls();
  ...
  'Create new secure channel': function (client) {
    ...
    channelsPage.navigate().navigateToCreateChannels();

    createEditChannelsPage.createNewSecureChannel();

    channelRouteContainer.validateChannelRoutes().selectChannelRoutes();
