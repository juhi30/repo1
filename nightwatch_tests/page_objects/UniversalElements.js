const universalElementsCommands = {
  ...
  searchForContactAndClick: function(contactName) {
    return this.waitForElementVisible(
      ...
      .waitForElementVisible(
        "@searchDropdownInput",
        5000,
        "Search dropdoown input is visible"
      )
  ...
  validateSearchDropdown: function(patientName) {
    return this.waitForElementVisible(
      ...
      .verify.visible(
        "@searchDropdownInput",
        "Search input is visible on click"
      )
      .setValue("@searchDropdownInput", patientName)
      .waitForElementVisible(
        "@searchDropdownFirstResult",
        2000,
        "First result on search dropdown is visible"
      )
  ...
  clickAddNewContact: function() {
    return this.click("@searchButton").waitForElementVisible(
      "@addNewContactButton",
      1500,
      "Add new contact button is visible"
    );
    ...
    return (
      this.waitForElementVisible(
        ...
        .verify.visible(
          ...
          "Profile in settings is visible"
        )
        .verify.visible(
          "@myPreferencesInSettingsDropdown",
          "Preferences in settings is visible"
        )
        .verify.visible(
          "@autoResponseInSettingsDropdown",
          "Otto response is visible!"
        )
  ...
  clickAppNavButtons: function() {
    return this.waitForElementVisible(
      "@myProfileButton",
      3000,
      "My Profile button is present"
    )
      .click("@myProfileButton")
      .verify.containsText(
        "@appHeaderTitle",
        "My Profile",
        "My Profile title present"
      )
      .click("@inboxTab")
  ...
  clickAutoResponse: function() {
    return this.click("@settingsButton")
      ...
      .verify.urlContains(
        "/organization/auto-response",
        "Auto-Response page is visible"
      );
  },
  ...
  clickOrgPreferences: function() {
    return this.click("@settingsButton")
      ...
      .verify.urlContains(
        ...
        "Organization Preferences page is visible"
      );
  },
  ...
  clickOrgProfile: function() {
    return this.click("@settingsButton")
      ...
      .waitForElementNotVisible(
        "@orgProfileInSettingsDropdown",
        5000,
        "Org Profile is hidden"
      )
      .verify.urlContains(
        "organization/profile",
        "Organization Profile page is visible"
      );
  },
  ...
  clickLogout: function() {
    return this.waitForElementVisible(
      ...
      .waitForElementNotPresent(
        "@logoutButton",
        1500,
        "Logout button no longer present"
      )
