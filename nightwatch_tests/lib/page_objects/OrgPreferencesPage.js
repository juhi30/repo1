...
const orgPreferencesCommands = {
  ...
  validatePageElements: function () {
    return this.waitForElementVisible('@toggleSound', 'Toggle sound is visible').verify.visible('@saveButton', 'Save Preferences button is visible');
  },
...
exports.default = OrgPreferencesPage;