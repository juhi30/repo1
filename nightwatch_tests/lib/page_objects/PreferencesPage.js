...
const preferencesCommands = {
  ...
  renderPageElements: function () {
    return this.waitForElementVisible('@desktopInboxToggle', 5000, 'Desktop inbox toggle is visible').verify.visible('@desktopChatToggle', 'Desktop chat toggle is visible')
    ...
    .verify.visible('@savePreferencesButton', 'Save preferences button is visible').verify.visible('@appStoreButton', 'App store button is visible').verify.visible('@googlePlayButton', 'Google play button is visible');
  },

  changeDesktopToggles: function () {
    return this.click('@desktopInboxToggle').click('@desktopChatToggle');
  },
  ...
  validateToggleChange: function () {
    return this.verify.cssProperty('@desktopInboxToggle', 'background-color', 'rgba(131, 196, 0, 1)', 'Desktop inbox toggle color is green and on').verify.cssProperty('@desktopChatToggle', 'background-color', 'rgba(131, 196, 0, 1)', 'Desktop chat toggle is green and on');
  ...
  clickSavePreferences: function () {
    return this.click('@savePreferencesButton').waitForElementVisible('@saveToast', 5000, 'Save preferences toast is visible');
  }
};
