const templatesCommands = {
  ...
  validateSMSFilter: function() {
    return this.verify
      .visible("@filterDropdown", "Channel filter is visible")
      .click("@filterDropdown")
      .waitForElementVisible(
        "@filterTextingChannel",
        5000,
        "Filter choices are visible"
      )
      .click("@filterTextingChannel")
      .waitForElementPresent(
        "@filterDropdown",
        5000,
        "Dropdown choices are closed"
      )
      .verify.containsText(
        "@filterDropdown",
        "Texting",
  ...
  validateChannelFilter: function() {
    return (
      this.click("@filterDropdown")
        .waitForElementVisible(
          "@filterAll",
          5000,
          "All channel filter is visible"
        )
        .click("@filterAll")
  ...
  clickCreateTemplate: function() {
    return this.click("@createTemplateButton").waitForElementVisible(
      "@createTemplateTitle",
      2000,
      "Create Template Popup is visible"
    );
  },
  ...
  saveNewTemplate: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "Save template is visible"
    )
      .click("@createTemplateSaveButton")
      .waitForElementNotPresent(
        "@createTemplateTitle",
        5000,
        "Create template popup is hidden"
      );
  },
  ...
  editTemplate: function() {
    return this.click("@firstTemplateEdit")
      .waitForElementVisible(
        "@createTemplateTitle",
        5000,
        "Edit template popup is visible"
      )
      .verify.visible(
        "@firstTemplateEditSaveButton",
        "Save template button is visible"
      )
      ...
      .waitForElementNotPresent(
        "@firstTemplateEditSaveButton",
        5000,
        "Edit template popup is not present"
      );
  },
  ...
  deleteTemplate: function() {
    return this.waitForElementVisible(
      "@firstTemplateDelete",
      1000,
      "Template delete button is visible"
    )
      .click("@firstTemplateDelete")
      .waitForElementVisible(
        "@firstTemplateDeleteFinal",
        1500,
        "Delete template popup is visible"
      )
      .click("@firstTemplateDeleteFinal")
      .waitForElementNotVisible(
        "@firstTemplateDeleteFinal",
        1500,
        "Delete template popup is hidden"
      );
  }
};
