const availabilityHoursCommands = {
    ...
    validateAvailabilityHoursEls: function () {
        return this.waitForElementVisible('@availabilityHoursToggle', 'Hours toggle is visible').click('@availabilityHoursToggle').verify.visible('@sundayFrom', 'Sunday hours visible').verify.visible('@mondayFrom', 'Monday hours visible').verify.visible('@tuesdayFrom', 'Tuesday hours visible').verify.visible('@wednesdayFrom', 'Wednesday hours visible').verify.visible('@thursdayFrom', 'Thursday hours visible').verify.visible('@fridayFrom', 'Friday hours visible').verify.visible('@saturdayFrom', 'Saturday hours visible').verify.visible('@sundayFrom', 'Sunday hours visible')
        ...
        .verify.visible('@autoResponseTextArea', 'Text area is visible').click('@availabilityHoursToggle');
    },

    updateAvailabilityHours: function () {
        return this.waitForElementVisible('@availabilityHoursToggle', 'Hours toggle is visibile').click('@availabilityHoursToggle').setValue('@sundayFrom', '');
    }
