...
module.exports = {
  ...
  'Render Auto-Response page and popup elements': function (client) {
    ...
    autoResponse.navigate().validateAutoResponseElements().validateAutoResponsePopupElements().navigate()
  ...
  'Try auto-response with a too long input': function (client) {
    ...
    autoResponse.navigate().fillInAutoResponse('I am the very model of a modern individual. I am animated, something-ated something sometihginsomething somethign else one more thing').submitAutoResponse().validateAutoResponseError();
  ...
  'Save a new auto-response': function (client) {
    ...
    autoResponse.navigate().fillInAutoResponse('Auto Response TEST!!!') // not clearing the original input when saved, causing it to become to long
    .submitAutoResponse().savedPrompt();
  ...
  'Render edit then delete OOO event': function (client) {
    ...
    autoResponse.validateEditOOOEvent().navigate().deleteLastOOOEvent().savedPrompt();
