const euProfileCommands = {
  ...
  verifyPasswordUpdatedToast: function() {
    return this.waitForElementVisible(
      ...
      5000,
      "Toast: Password Updated Successfully is visible"
    );
  },
  ...
  fillInCurrentPasswordInput: function(currentPassword) {
    return this.waitForElementVisible(
      ...
      1000,
      `filled in Current Password with ${currentPassword}`
  ...
  fillInNewPasswordInput: function(newPassword) {
    return this.waitForElementVisible(
      "@newPasswordInput",
      1000,
      `filled in New Password with ${newPassword}`
  ...
  fillInRetypeNewPasswordInput: function(newPassword) {
    return this.waitForElementVisible(
      ...
      1000,
      `filled in Retype New Password with ${newPassword}`
