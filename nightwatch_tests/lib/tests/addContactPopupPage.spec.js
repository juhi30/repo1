...
module.exports = {
  ...
  'Open Add Contact Page and render elements': function (client) {
    ...
    contactsPage.navigate().clickAddContact().clickAddNewContact();

    addContacts.renderAddContactsPage().renderPageElements();
  ...
  'Make sure alert validators is showing on input': function (client) {
    ...
    addContacts.clickAddContact().validateErrorPrompt().validateInputValidators();
  ...
  'Open add photo popup and render elements': function (client) {
    ...
    addContacts.validatePhotoPopup().clickClosePhotoPopup();
  ...
  'Fill out form and add it as a new contact': function (client) {
    ...
    addContacts.fillInFormPartOne('steve' + randoNum, 'monstermash', 'bash' + randoNum, 'october', '31', '1936').fillInFormPartTwo('12345', '8435559876', 'work', 'steveMM@mooosh.com', 'secondary', 'It was a graveyard smash! (corrected thanks to keaton)').clickAddContact();
